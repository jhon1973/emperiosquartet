...
class DashboardPage extends StatelessWidget {
  ...
  Future<void> _deleteBudget(BuildContext context) async {
    final budgetDoc =
        await budgetRef.doc(user!.uid).collection('budgets').doc('main').get();
  ...
  void _notifyNoBudget(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Please input a budget first.'),
